...
PPE_API extern pp_cs_cstr * ppe_cs_split(ppe_cs_cstr * restrict arr, ppe_uint * cnt, ppe_cstr restrict b, ppe_size * restrict bsz, const ppe_str_option opt, const ppe_cstr restrict d, const ppe_cstr restrict s);
