...
PPE_API extern ppe_cs_snippet ppe_cs_split(const ppe_cstr restrict s, const ppe_cstr restrict d, ppe_cs_snippet restrict spt, const ppe_cstr * restrict ss, const ppe_str_option opt);
