...
PPE_API extern ppe_cstr_c ppe_cs_trim(ppe_cstr_c const restrict s, ppe_cstr_c restrict t, ppe_cstr restrict b, ppe_size * restrict bsz, ppe_str_option opt);

static inline ppe_cstr_c ppe_cs_trim_left(ppe_cstr_c const restrict s, ppe_cstr restrict b, ppe_size * bsz)
{
    return ppe_cs_trim(s, NULL, b, bsz, PPE_STR_OPT_LEFT_END);
} /* ppe_cs_trim_left */

static inline ppe_cstr_c ppe_cs_trim_right(ppe_cstr_c const restrict s, ppe_cstr restrict b, ppe_size * bsz)
{
    return ppe_cs_trim(s, NULL, b, bsz, PPE_STR_OPT_RIGHT_END);
} /* ppe_cs_trim_right */

static inline ppe_cstr_c ppe_cs_trim_both(ppe_cstr_c const restrict s, ppe_cstr restrict b, ppe_size * bsz)
{
    return ppe_cs_trim(s, NULL, b, bsz, PPE_STR_OPT_BOTH_ENDS);
} /* ppe_cs_trim_both */
